"""
A module for logging setup in the app-core package.
"""
...
def _setup_file_handler(
    ...
    :rtype: NoneType
    """
    logs_folder_path: str = _create_logs_folder(init_settings)
    log_filename: str = _build_log_filename(init_settings)
